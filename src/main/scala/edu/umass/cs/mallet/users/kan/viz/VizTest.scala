...
//      rotateY(angle)
 ...
 def line_xy(screenwidth:Int, screenheight:Int, colwidth:Int, lineheight:Int) = new Iterator[(Int,Int)] { 
   
   private var x = colwidth
   private var y = lineheight
    
   def hasNext = x < screenwidth 
